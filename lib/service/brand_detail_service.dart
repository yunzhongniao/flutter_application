...
class BrandDetailService {
  Future<JsonResult<BrandDetailEntity>> queryBrandDetail(
      Map<String, dynamic> parameters) async {
    JsonResult<BrandDetailEntity> jsonResult =
        new JsonResult<BrandDetailEntity>();
    try {
      var response = await HttpUtil.instance
          .get(AppUrls.BRAND_DETAIL, parameters: parameters);
