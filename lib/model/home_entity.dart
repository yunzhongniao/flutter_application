...
class HomeEntity {
  ...
  HomeEntity.fromJson(Map<String, dynamic> json) {
    if (json['newGoodsList'] != null) {
      newGoodsList = new List<GoodsEntity>();
      (json['newGoodsList'] as List).forEach((v) {
        newGoodsList.add(new GoodsEntity.fromJson(v));
      });
    }
    if (json['couponList'] != null) {
      couponList = new List<HomeModelCouponlist>();
      (json['couponList'] as List).forEach((v) {
        couponList.add(new HomeModelCouponlist.fromJson(v));
      });
    }
    if (json['channel'] != null) {
      channel = new List<HomeModelChannel>();
      (json['channel'] as List).forEach((v) {
        channel.add(new HomeModelChannel.fromJson(v));
      });
    }
    if (json['grouponList'] != null) {
      grouponList = new List<HomeModelGrouponlist>();
      (json['grouponList'] as List).forEach((v) {
        grouponList.add(new HomeModelGrouponlist.fromJson(v));
      });
    }
    if (json['banner'] != null) {
      banner = new List<HomeModelBanner>();
      (json['banner'] as List).forEach((v) {
        banner.add(new HomeModelBanner.fromJson(v));
      });
    }
    if (json['brandList'] != null) {
      brandList = new List<HomeModelBrandlist>();
      (json['brandList'] as List).forEach((v) {
        brandList.add(new HomeModelBrandlist.fromJson(v));
      });
    }
    if (json['hotGoodsList'] != null) {
      hotGoodsList = new List<GoodsEntity>();
      (json['hotGoodsList'] as List).forEach((v) {
        hotGoodsList.add(new GoodsEntity.fromJson(v));
      });
    }
    if (json['topicList'] != null) {
      topicList = new List<HomeModelTopiclist>();
      (json['topicList'] as List).forEach((v) {
        topicList.add(new HomeModelTopiclist.fromJson(v));
      });
    }
    if (json['floorGoodsList'] != null) {
      floorGoodsList = new List<HomeModelFloorgoodslist>();
      (json['floorGoodsList'] as List).forEach((v) {
        floorGoodsList.add(new HomeModelFloorgoodslist.fromJson(v));
      });
    }
  }
...
class HomeModelBrandlist {
  ...
  HomeModelBrandlist(
      {this.floorPrice, this.picUrl, this.name, this.id, this.desc});
...
class HomeModelFloorgoodslist {
  ...
  HomeModelFloorgoodslist.fromJson(Map<String, dynamic> json) {
    ...
    if (json['goodsList'] != null) {
      goodsList = new List<GoodsEntity>();
      (json['goodsList'] as List).forEach((v) {
        goodsList.add(new GoodsEntity.fromJson(v));
      });
    }
    id = json['id'];
  }
...
class HomeModelOrder {
  String name;
  int id;
  String iconUrl;

  HomeModelOrder({this.name, this.id, this.iconUrl});

  HomeModelOrder.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    id = json['id'];
    iconUrl = json['iconUrl'];
  }
