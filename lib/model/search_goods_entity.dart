...
class SearchGoodsEntity {
  ...
  SearchGoodsEntity.fromJson(Map<String, dynamic> json) {
    ...
    page = json['page'];
    if (json['list'] != null) {
      xList = new List<GoodsEntity>();
      (json['list'] as List).forEach((v) {
        xList.add(new GoodsEntity.fromJson(v));
      });
    }
    if (json['filterCategoryList'] != null) {
      filterCategoryList = new List<SearchGoodsFiltercategorylist>();
      (json['filterCategoryList'] as List).forEach((v) {
        filterCategoryList.add(new SearchGoodsFiltercategorylist.fromJson(v));
      });
    }
  }
