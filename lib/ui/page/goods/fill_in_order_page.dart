...
import 'package:flutter_application/ui/widgets/item_text.dart';
import 'package:flutter_application/ui/widgets/right_arrow.dart';
...
import 'package:flutter_application/view_model/fill_in_order_view_model.dart';
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: <Widget>[
                              Text(model.fillInOrderCheckAddress.name,
                                  style: FMTextStyle.color_333333_size_42),
                              Padding(
                                padding: EdgeInsets.only(
                                    left: ScreenUtil()
                              ...
                              Text(model.fillInOrderCheckAddress.tel,
                                  style: FMTextStyle.color_333333_size_42),
                            ],
                          ),
                          Padding(
